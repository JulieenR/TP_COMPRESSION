...
% Quelques vérifications d'arguments
%-----------------------------------
...
if (N <= R)     error('Le signal x doit être plus long que le retard du filtre'); end;

% Périodisation (pour le traitement des bords) et filtrage
%--------------------------
